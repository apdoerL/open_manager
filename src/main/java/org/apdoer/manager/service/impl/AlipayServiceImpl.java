...
import org.apdoer.manager.repository.AlipayRepository;
...
public class AlipayServiceImpl implements AlipayService {
    ...
    @Override
    public String toPayAsPC(AlipayPo alipay, TradeVo trade) throws Exception {
    ...
    @Override
    public String toPayAsWeb(AlipayPo alipay, TradeVo trade) throws Exception {
        if(alipay.getId() == null){
            throw new BadRequestException("请先添加相应配置，再操作");
        }
        AlipayClient alipayClient = new DefaultAlipayClient(alipay.getGatewayUrl(), alipay.getAppID(), alipay.getPrivateKey(), alipay.getFormat(), alipay.getCharset(), alipay.getPublicKey(), alipay.getSignType());
    ...
    @Override
    public AlipayPo find() {
        Optional<AlipayPo> alipayConfig = alipayRepository.findById(1L);
    ...
    public AlipayPo update(AlipayPo alipayConfig) {
