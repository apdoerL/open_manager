...
//import org.apdoer.manager.mapper.LogErrorMapper;
//import org.apdoer.manager.mapper.LogSmallMapper;
//import org.apdoer.manager.repository.LogRepository;
...
//        Page<LogPo> page = logRepository.findAll(((root, criteriaQuery, cb) -> QueryHelper.getPredicate(root, criteria, cb)),pageable);
...
//    public void save(String username, String ip, ProceedingJoinPoint joinPoint, LogPo log){
//
//        MethodSignature signature = (MethodSignature) joinPoint.getSignature();
//        Method method = signature.getMethod();
//        SystemControllerLog aopLog = method.getAnnotation(SystemControllerLog.class);
//
//        // 描述
//        if (log != null) {
