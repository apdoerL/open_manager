...
//    }
//
//    @SystemControllerLog("新增菜单")
//    @PostMapping(value = "/menus")
//    @PreAuthorize("hasAnyRole('ADMIN','MENU_ALL','MENU_CREATE')")
//    public ResponseEntity create(@Validated @RequestBody MenuPo resources){
...
//    }
//
//    @SystemControllerLog("修改菜单")
//    @PutMapping(value = "/menus")
//    @PreAuthorize("hasAnyRole('ADMIN','MENU_ALL','MENU_EDIT')")
//    public ResponseEntity update(@Validated(MenuPo.Update.class) @RequestBody MenuPo resources){
//        menuService.update(resources);
//        return new ResponseEntity(HttpStatus.NO_CONTENT);
//    }
//
//    @SystemControllerLog("删除菜单")
//    @DeleteMapping(value = "/menus/{id}")
//    @PreAuthorize("hasAnyRole('ADMIN','MENU_ALL','MENU_DELETE')")
//    public ResponseEntity delete(@PathVariable Long id){
//        List<MenuPo> menuList = menuService.findByPid(id);
//
//        // 特殊情况，对级联删除进行处理
